...
export default function PostItem({ post, hero }) {
  return (
    <>
      ...
      <div className="md:col-span-2 md:col-start-2 border-b border-black border-opacity-10 md:mt-3 pb-2.5 md:flex md:flex-row justify-between">
        <h2 className="m-0 text-sm leading-snug font-serif md:pr-8 subpixel-antialiased">
          {hero && (
            <svg
